...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <h1 class="title">La mejor autoescuela de toda Bolivia.</h1>
            <h4>Ven y aprende a manejar un automovil en cuestion de semanas, nuestras enseñanza es 80% practica y 30% teorico, en pocas  semanas tendras los conocimientos necesarios para conducir un automovil.</h4>
            <br />
                ...
                <div class="col-md-4">
                    <div class="team-player">
                        ...
                        <h4 class="title">Christian Louboutin<br />
                            <small class="text-muted">Instructora</small>
                        </h4>
                        <p class="description">You can write here details about one of your team members. You can give more details about what they do. Feel free to add some <a href="#">links</a> for people to be able to follow them outside the site.</p>
                        <a href="#pablo" class="btn btn-simple btn-just-icon"><i class="fa fa-twitter"></i></a>
